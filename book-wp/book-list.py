...
summaries = pd.read_csv(path_summaries, usecols=['isbn', 'Summary', 'Category' ],dtype={'isbn': str})
...
merged.to_csv(
    "C:\\Users\pauli\Work\Book Recommendation System\dataset\\books_wordpress.csv")
